...
import { openArtifact, saveArtifactToLibrary, selectHtmxServerPort } from '@renderer/store/artifacts'
...
const ArtifactCard: FC<ArtifactCardProps> = ({
  ...
  const handleSave = useCallback(() => {
    // First open the artifact (creates it in store)
    dispatch(
      openArtifact({
        parsedArtifact: artifact,
        conversationId,
    ...
    // Then save it (will use the active artifact from store)
    // Note: This will be handled by the modal's save action
    message.info(t('artifacts.save_from_modal'))
  }, [dispatch, artifact, conversationId, messageId, t])
