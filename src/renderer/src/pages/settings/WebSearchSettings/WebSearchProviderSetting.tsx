...
import BochaLogo from '@renderer/assets/images/search/bocha.svg'
import ExaLogo from '@renderer/assets/images/search/exa.svg'
...
import ZhipuLogo from '@renderer/assets/images/search/zhipu.svg'
...
const WebSearchProviderSetting: FC<Props> = ({ providerId }) => {
  ...
  const openLocalProviderSettings = async () => {
    if (officialWebsite) {
      await window.api.searchService.openSearchWindow(provider.id)
    }
  }
