// [v2] Legacy PNG logo imports — migrated to resolveProviderIcon from @cherrystudio/ui/icons.
...
export const SYSTEM_PROVIDERS_CONFIG: Record<SystemProviderId, SystemProvider> = {
  ...
  uar: {
    ...
    type: 'openai',
    apiKey: '',
    apiHost: 'http://127.0.0.1:18790/v1',
    models: [],
    isSystem: true,
    enabled: true
  }
...
// [v2] PROVIDER_LOGO_MAP & getProviderLogo — migrated to resolveProviderIcon from @cherrystudio/ui/icons.
// Remove entirely after v2 migration is complete.
