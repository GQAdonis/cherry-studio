...
export const CHERRY_STUDIO_PROTOCOL = 'prometheusstudio'
...
export function registerProtocolClient(app: Electron.App) {
  ...
  app.setAsDefaultProtocolClient('prometheusstudio')
}
...
const DESKTOP_FILE_NAME = 'prometheusstudio-url-handler.desktop'

/**
 * Sets up deep linking for the AppImage build on Linux by creating a .desktop file.
 * This allows the OS to open prometheusstudio:// URLs with this App.
 */
