...
export const CHERRY_STUDIO_PROTOCOL = 'boss'
...
export function handleProtocolUrl(url: string) {
  ...
  // The url will be in the format: boss://data?param1=value1&param2=value2
...
const DESKTOP_FILE_NAME = 'boss-url-handler.desktop'

/**
 * Sets up deep linking for the AppImage build on Linux by creating a .desktop file.
 * This allows the OS to open boss:// URLs with this App.
 */
