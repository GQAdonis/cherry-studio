...
export default class AppUpdater {
  ...
  constructor(mainWindow: BrowserWindow) {
    ...
    autoUpdater.on('error', (error) => {
      // Simple logging of error information and timestamp
    ...
    // When the update content download is complete
  ...
  public async checkForUpdates() {
    ...
    try {
      ...
      if (update?.isUpdateAvailable && !this.autoUpdater.autoDownload) {
        // If autoDownload is false, we need to call the function below to trigger it
